...
class GameboardFactory() {
  ...
  def createGameboard(size: GameboardSize): Gameboard[Field] = {
    ...
    var field5 = Field(5, FieldStatus.Empty)
    var field6 = Field(6, FieldStatus.Empty)
    var field7 = Field(7, FieldStatus.Empty)
    var field8 = Field(8, FieldStatus.Empty)
    var field9 = Field(9, FieldStatus.Empty)
    var field10 = Field(10, FieldStatus.Empty)
    var field11 = Field(11, FieldStatus.Empty)
    var field12 = Field(12, FieldStatus.Empty)
    var field13 = Field(13, FieldStatus.Empty)
    var field14 = Field(14, FieldStatus.Empty)
    var field15 = Field(15, FieldStatus.Empty)
    var field16 = Field(16, FieldStatus.Empty)
    var field17 = Field(17, FieldStatus.Empty)
    var field18 = Field(18, FieldStatus.Empty)
    var field19 = Field(19, FieldStatus.Empty)
    var field20 = Field(20, FieldStatus.Empty)
    var field21 = Field(21, FieldStatus.Empty)
    var field22 = Field(22, FieldStatus.Empty)
    var field23 = Field(23, FieldStatus.Empty)
    size match {
